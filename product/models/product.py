...
class Product(models.Model):
    ...
    description = models.TextField(max_length=500, blank=True)  # Remover null=True para manter consistência
    # Campo price para o preço do produto, deve ser um inteiro positivo, pode ser vazio ou nulo
    price = models.PositiveIntegerField(blank=True, null=True)  # Adicionar blank=True para permitir campos em branco
